...
"ui-datepicker-days-cell-over";this.regional=[];this.regional[""]={closeText:"Done",prevText:"Pøedchozí",nextText:"Další",currentText:"Today",monthNames:["Leden","Únor","Bøezen","Duben","Kvìten","Èerven","Èervenec","Srpen","Záøí","Øíjen","Listopad","Prosinec"],monthNamesShort:['Le','Ún','Bø','Du','Kv','Èn', 'Èc','Sr','Zá','Øí','Li','Pr'],dayNames:['Nedìle','Pondìlí','Úterý','Støeda','Ètvrtek','Pátek','Sobota'],dayNamesShort:['Ne','Po','Út','St','Èt','Pá','So'],dayNamesMin:['Ne','Po','Út','St','Èt','Pá','So'],
weekHeader:"Wk",dateFormat:"d.m.yy",firstDay:1,isRTL:false,showMonthAfterYear:false,yearSuffix:""};this._defaults={showOn:"focus",showAnim:"fadeIn",showOptions:{},defaultDate:null,appendText:"",buttonText:"...",buttonImage:"",buttonImageOnly:false,hideIfNoPrevNext:false,navigationAsDateFormat:false,gotoCurrent:false,changeMonth:false,changeYear:false,yearRange:"c-80:c+10",showOtherMonths:false,selectOtherMonths:false,showWeek:false,calculateWeek:this.iso8601Week,shortYearCutoff:"+10",
