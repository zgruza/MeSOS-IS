...
<body class="etk-menu-loaded">
	<div id="wrapper">
		...
		<tr>
			...
			<td><input type="text" name="pr" class="input--text text" id="frm-pr" value="<?php if(isset($predmet)){echo $predmet;} elseif(isset($_GET['subj'])){echo $_GET['subj'];}?>"></td>
		</tr>
